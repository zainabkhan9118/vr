      ...
      <div className="max-w-4xl mx-auto py-16 relative z-10 w-full">
        ...
        <div className="mt-12 flex flex-col md:flex-row justify-center items-center gap-6 text-center md:text-left">
          <div className="flex items-center">
            ...
            <a href="mailto:hello@mindplayer.com" className="text-xl underline hover:text-cyan-300 transition-colors">hello@mindplayer.com</a>
          </div>
        ...
        <div className="mt-8 text-center">
          <p
            ...
            className="inline-block text-cyan-300 underline hover:text-cyan-100 text-lg transition-colors"
          >
